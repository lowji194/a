var time = number * 1000; // Don't modify
var success = 0;

/* Don't modify code below */
setTimeout(function() {
    console.log("%c Script Auto Addfriends Facebook 29/07/2022", 'color: #008000');
    ...
    console.warn("%c Times Delays: " + number + " seconds", 'color: #ff0000');
